...
export default function Footer({ slug, customization }) {
  ...
  return (
    <>
    <footer className={`fixed bottom-0 left-0 right-0 z-50 rounded-t-xl h-14 flex w-full items-center justify-around mx-auto dark:bg-gray-900 md:max-w-[50%] lg:max-w-[40%] xl:max-w-[30%] ${isRTL ? 'flex-row-reverse' : ''}`} style={{backgroundColor: customization?.selectedBgColor}}>
