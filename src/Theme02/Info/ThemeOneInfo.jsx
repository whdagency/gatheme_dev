        ...
        <ScrollArea className="h-[75vh] !p-0 w-full ">
          ...
          <div className="relative p-0 flex flex-col items-center w-full py-0">
            ...
            <div className={`flex flex-col items-center w-[90%] gap-5`}>
                ...
                <Avatar className="h-28 w-28 rounded-full mb-2">
                      <AvatarImage
                      src={`${APIURLS3}/${resInfo.logo}`}
                      className="bg-white h-28 max-w-28  object-cover"
                      />
                      <AvatarFallback className="bg-slate-500 h-28 w-28 rounded-full"></AvatarFallback>
                  </Avatar>
